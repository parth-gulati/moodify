              ...
              <div className="space-y-3">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  {result.recommended_songs.map((song, index) => (
                    <div
                      key={song.uri || index}
                      className="animate-fade-in-up group rounded-lg border border-border/30 p-4 backdrop-blur-md transition-all hover:border-primary/50 hover:bg-secondary/30"
                      style={{
